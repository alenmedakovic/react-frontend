...
import "./home.css";
import { Navbar, Body, Header } from "../../components/index";
import { Link } from "react-router-dom";

function Home() {
  return (
    <div>
      <div class="isolate bg-red">
    ...
    <div>
      <nav class="flex h-9 items-center justify-between" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
          ...
          <a href="/signup" class="inline-block rounded-lg px-3 py-1.5 ml-6 bg-blue-700 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20">Sign up</a>
